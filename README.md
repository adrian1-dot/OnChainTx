...
* run `cabal update`
* run `cabal build`
* run `cabal exec -- plutus-starter-pab`
* open a new terminal 
* run `chmod +x showOnChainTx.sh`
* run `./showOnChainTx`
* change back to the pab terminal and press ENTER
* now you can see the last added transaction
